...
<template>
	<div>
		<div class="card">
						...
						<template v-if="tickets?.length">
							<tr v-for="(ticket, i) in tickets" class="border-b border-gray-200 dark:border-gray-700">
								...
								<td class="py-4 px-6 bg-gray-50 dark:bg-gray-800">
									<nuxt-link :to="`/volunteers/dashboard/support/${ticket.id}`" class="text-sju-50">
										{{ ticket.title }}
									</nuxt-link>
								</td>
			...
			<div class="text-end">
				<nuxt-link to="/volunteers/dashboard/support/create" class="btn-primary inline-block text-sm"
