<script setup>
	...
	const updateLicense = async (form, node) => {
		...
		const { error } = await memberStore.updateLicense(body)
		// On errors
...
<template>
	<div>
		<members-profile-nav active="license" />

		<div class="form">
			<FormKit type="form" :actions="false" @submit="updateLicense" enctype="multipart/form-data">
				<!-- Rules and Picture -->
				<div class="flex flex-col md:flex-row justify-between mb-10">
					...
					<img
						:src="userData?.newspaper_license || '/images/letter.png'"
